export const slaughterhouseAbi = [
  ...
  { type: "function", name: "withdrawRewards", inputs: [], outputs: [], stateMutability: "nonpayable" },
  {
    type: "event",
    name: "BeefPackaged",
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      { name: "newProtocolRewardBasisPoints", type: "uint256", indexed: false, internalType: "uint256" },
      { name: "newArbitersRewardBasisPoints", type: "uint256", indexed: false, internalType: "uint256" },
    ],
    anonymous: false,
  },
  {
