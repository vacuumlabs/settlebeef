export const beefAbi = [
  ...
  { type: "function", name: "arbiterAttend", inputs: [], outputs: [], stateMutability: "nonpayable" },
  {
    type: "function",
    name: "arbiters",
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: "protocolRewardBasisPoints", type: "uint256", internalType: "uint256" },
          { name: "arbitersRewardBasisPoints", type: "uint256", internalType: "uint256" },
        ],
      },
    ],
    stateMutability: "view",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_slaughterhouse", type: "address", internalType: "address payable" },
      { name: "_protocolRewardBasisPoints", type: "uint256", internalType: "uint256" },
      { name: "_arbitersRewardBasisPoints", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
  ...
  },
  {
    ...
    name: "swapRouter",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract IV3SwapRouter" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [{ name: "arbiter", type: "address", indexed: true, internalType: "address" }],
    anonymous: false,
  },
  { type: "event", name: "BeefCooking", inputs: [], anonymous: false },
  {
    ...
    inputs: [
      ...
      { name: "settleStart", type: "uint256", indexed: false, internalType: "uint256" },
      { name: "title", type: "string", indexed: false, internalType: "string" },
      { name: "description", type: "string", indexed: false, internalType: "string" },
      { name: "arbiters", type: "address[]", indexed: false, internalType: "address[]" },
      { name: "protocolRewardBasisPoints", type: "uint256", indexed: false, internalType: "uint256" },
      { name: "arbitersRewardBasisPoints", type: "uint256", indexed: false, internalType: "uint256" },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    type: "event",
    name: "BeefWithdrawn",
    inputs: [{ name: "hadBeenCooking", type: "bool", indexed: false, internalType: "bool" }],
    anonymous: false,
  },
  {
    type: "event",
  ...
  { type: "error", name: "BeefNotArbiter", inputs: [{ name: "sender", type: "address", internalType: "address" }] },
  {
    type: "error",
