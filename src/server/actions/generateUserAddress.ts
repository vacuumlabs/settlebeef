...
import { LinkedAccountWithMetadata, PrivyClient, User, WalletWithMetadata } from "@privy-io/server-auth"
...
export type GenerateUserAddressParams = Parameters<typeof privy.importUser>[0]["linkedAccounts"]

export const generateUserAddress = async (params: GenerateUserAddressParams) => {
